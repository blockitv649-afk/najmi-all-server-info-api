# TG- NAJMI_ADMIN
#YT- NAJMI_FF_EXPERIMENT
#CODE MAKEING BY @NAJMI_ADMIN_KING
import asyncio
import time
import httpx
import json
...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=4344189542&password=INFO_705OH_BY_SAURABH_BHAI_J0QSV"
    elif r == "BD":
        return "uid=4344190901&password=BDINFO_7LHYG_BY_SAURABH_BHAI_PZYRC"
    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=4344192584&password=GHOSTINFOFORBR_97QBG_BY_SAURABH_BHAI_DE4ME"
    else:
        return "uid=4344192599&password=GHOSTINFOFORBR_5U4K8_BY_SAURABH_BHAI_ZZ093"
